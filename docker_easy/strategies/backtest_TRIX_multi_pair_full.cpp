...
const vector<uint> MAX_OPEN_TRADES_TO_TEST{2, 3, 4, 5, 6, 7};
const vector<string> COINS = {"BTC", "ETH", "BNB", "XRP", "ADA", "SOL", "DOGE", "DOT", "TRX", "AVAX", "MATIC",
                              "LTC", "FTT", "LINK", "UNI", "XMR", "XLM", "NEAR", "ALGO", "ATOM", "VET", "MANA", "APE", "XTZ",
                              "SAND", "THETA", "EGLD", "EOS", "AAVE", "FTM"};
...
const vector<string> DATAFILES = {"./data/Binance/" + timeframe + "/" + COINS[0] + "-USDT.csv",
                                  ...
                                  "./data/Binance/" + timeframe + "/" + COINS[10] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[11] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[12] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[13] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[14] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[15] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[16] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[17] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[18] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[19] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[20] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[21] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[22] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[23] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[24] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[25] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[26] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[27] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[28] + "-USDT.csv",
                                  "./data/Binance/" + timeframe + "/" + COINS[29] + "-USDT.csv"};
...
vector<int> range_EMA = integer_range(40, period_max_EMA + 3, 3); // best calmar from 40 to 122: 2.34
