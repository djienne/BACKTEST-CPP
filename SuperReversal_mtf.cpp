...
const vector<string> DATAFILES_1h = {"./data/Binance/" + timeframe_1 + "/" + COINS[0] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[1] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[2] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[3] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[4] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[5] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[6] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[7] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[8] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[9] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[10] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[11] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[12] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[13] + "-USDT.csv",
                                     "./data/Binance/" + timeframe_1 + "/" + COINS[14] + "-USDT.csv",
...
const vector<string> DATAFILES_15m = {"./data/Binance/" + timeframe_2 + "/" + COINS[0] + "-USDT.csv",
                                      ...
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[2] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[3] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[4] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[5] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[6] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[7] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[8] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[9] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[10] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[11] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[12] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[13] + "-USDT.csv",
                                      "./data/Binance/" + timeframe_2 + "/" + COINS[14] + "-USDT.csv",
