...
const exchange_limit = JSON.parse(fs.readFileSync('./exchange_limit.json', 'utf8'));
const tf_ms = JSON.parse(fs.readFileSync('./tf_ms.json', 'utf8'));
const coin_list = JSON.parse(fs.readFileSync('./pair_list.json', 'utf8'));
